...
enum class AutoAimMode { Normal = 0, HeroFirst = 1, SentryFirst = 2, BaseFirst = 3 };
struct GlobalSettings final {
    ...
    AutoAimMode getAutoAimMode() const noexcept {
        return static_cast<AutoAimMode>(autoAimMode);
    }
