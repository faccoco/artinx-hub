...
class Crc {
    constexpr const static uint8_t CRC8_TAB[256] = {
    ...
    constexpr const static uint16_t CRC16_TAB[256] = {
...
public:
    constexpr const static uint8_t CRC8_INIT = 0xFF;
    constexpr const static uint16_t CRC16_INIT = 0xFFFF;
